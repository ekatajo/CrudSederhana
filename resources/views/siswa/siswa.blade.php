        ...
        <table class="table table-striped table-sm">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{$s -> tmplahir}}</td>
              <td>{{$s -> tgllahir}}</td>
              <td><a href="/siswa/{{$s->nis}}/delete" class="btn btn-sm btn-outline-secondary">Hapus</a>
                <a href="/siswa/{{$s->nis}}/edit" class="btn btn-sm btn-outline-warning">Edit</a></td>
            </tr>
            @endforeach
          </tbody>
        </table>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="mb-3">
   ...
   <div class="mb-3">
    ...
    <input type="text" name="tahunmasuk" class="form-control" id="exampleInputPassword1">
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">ID Angkatan</label>
    <input type="text" name="idangkatan" class="form-control" id="exampleInputPassword1">
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">ID Kelas</label>
    <input type="text" name="idkelas" class="form-control" id="exampleInputPassword1">
  </div>
